---
title: "Explanation of LGCP INLA code"
author: "Synne"
date: "2025-06-20"
output:
  pdf_document:
...
$$p(s) = \frac{\lambda(s)}{\lambda_{\max}},$$ where $\lambda_{\max}$ is a fixed upper bound on the intensity. This ensures that the retained points follow the desired LGCP with spatially varying intensity.
...
8.  Fit the model using INLA, optionally estimating the covariate coefficient $\beta$.
